# Scribo Fashn AI Python API library
...
pip install git+ssh://git@github.com/relferreira/fashn-python-sdk.git
```
...
```sh
# install from the production repo
pip install 'scribo_fashn_ai[aiohttp] @ git+ssh://git@github.com/relferreira/fashn-python-sdk.git'
```
...
These methods return an [`APIResponse`](https://github.com/relferreira/fashn-python-sdk/tree/main/src/scribo_fashn_ai/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/relferreira/fashn-python-sdk/tree/main/src/scribo_fashn_ai/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/relferreira/fashn-python-sdk/issues) with questions, bugs, or suggestions.
